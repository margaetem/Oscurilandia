...
public class Tablero {
	...
	// Metodos
	/**
	 * Se usa el metodo crearCarro para generar las 3 Kromis, 5 Caguanos y 10
	 * Trupallas.
	 */
	...
	/**
	 * Se crea Kromi y se posiciona de forma aleatoria dentro de la matriz y se crea
	 * un margen para que la kromi siempre quede dentro del tablero.
	 */
	...
	/**
	 * Se crea un caguano y se genera su ubicacion aleatoria dentro del tablero en
	 * una posicion nueva para evitar que quede sobre otro vehiculo.
	 */
	...
	/**
	 * Se crea un trupalla y se genera su ubicacion aleatoria dentro del tablero en
	 * una posicion nueva para evitar que quede sobre otro vehiculo.
	 */
	...
	/**
	 * Este metodo se utiliza para verificar que el usuario ingrese un numero dentro
	 ...
	 * 
	 * @param completa si es true muestra la matriz completa tanto los vehiculos
	 *                 como los lanzamientos, si es false solo muestra los
	 *                 lanzamientos.
	 */
	...
	/**
	 * Este metodo se utiliza para crear un huevo e indicarle al usuario el limite
	 * de donde lanzar el huevo tanto de la fila como columna de la matriz.
	 * 
	 */
	...
	/**
	 * Calcula el puntaje por cada lanzamiento, segun la posicion y asigna el
	 * puntaje segun donde cayo el lanzamiento, y pone una H en el tablero. tambien
	 * revisa si el usuario destruyo por completo el carro y le asigna el puntaje
	 * segun que carro destruyo.
	 * 
	 * @param filaObjetivo    fila a la que apunto el usuario.
	 * @param columnaObjetivo columna a la que apunto el usuario.
	 * @param h1              es un objeto de la clase huevo que guarda los datos
	 *                        del lanzamiento correspondiente.
	 */
	...
	/**
	 * 
	 * @param posicion muestra el puntaje individual del lanzamiento segun su
	 *                 posicion.
